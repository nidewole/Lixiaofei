...
public class ResTools {
	private final static String TAG = ResTools.class.getSimpleName();
    ...
    public static String geFileFromAssets(Context context, String fileName) {
        if (context == null || fileName.isEmpty()) {
        	throw new NullPointerException("context == null || fileName 是null");
        }
    ...
    public static String geFileFromRaw(Context context, int resId) {
        if (context == null) {
        	throw new NullPointerException("context == null || resId == 0");        }
