...
public class RandomTools {
	 private final static String TAG = RandomTools.class.getSimpleName();
	 ...
	 private RandomTools() {
	   ...
	   /**
	    ...
	    public static String getRandom(String source, int length) {
	    	if(!source.isEmpty()){
	    		LogTools.d(TAG, source,length);
	    	}
	        return source.isEmpty() ? null : getRandom(source.toCharArray(), length);
	    }
