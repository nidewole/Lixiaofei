...
import com.ctvit.dev.tools.ShellTools.CommandResult;
...
public class PkTools {
	private final static String TAG = PkTools.class.getSimpleName();
    ...
    public static final int install(Context context, String filePath) {
        if (PkTools.isSystemApplication(context) || ShellTools.checkRootPermission()) {
    ...
    public static int installSilent(Context context, String filePath, String pmParams) {
        ...
        CommandResult commandResult = ShellTools.execCommand(command.toString(), !isSystemApplication(context), true);
    ...
    public static int getInstallLocation() {
        CommandResult commandResult = ShellTools.execCommand(
        ...
        if (commandResult.result == 0 && commandResult.successMsg != null && commandResult.successMsg.length() > 0) {
            try {
                ...
                e.printStackTrace();
                LogTools.e(TAG, "pm get-install-location error");
            }
        }
